...
import TextAboutUs from "../constant/text.aboutus.jsx";
...
export default function AboutUs() {
  return (
    <div className="bg-slate-50">
      ...
      {/* benefits */}
      <section className="py-36 flex flex-col md:flex-row items-center gap-4">
        <div className="md:w-1/2 space-y-8 ps-8">
        ...
        <div className="md:w-1/2 bg-white shadow-2xl md:grid grid-cols-2 md:gap-8 p-14 md:rounded-s-3xl space-y-3 md:space-y-0">
          <Benefits
            title="Modern House"
            color="bg-violet-100"
            img={icons.house}
      ...
      <section className="container mx-auto py-16">
        ...
        <div className="flex flex-col md:flex-row justify-between px-4 md:px-0 space-y-4 md:space-y-0">
